    ...
    <div class="container">
        ...
        <tbody>
          ...
          <td>
            <b-button-group size="sm">
              <b-button show variant="primary" v-b-tooltip.hover title="Editar cadastro" @click="selecionar(pessoa)">
                <font-awesome-icon icon="pencil-alt"/>
              </b-button>
              <b-button variant="danger" v-b-tooltip.hover title="Deletar cadastro" @click="deletar(pessoa.id)">
      ...
      <div class="row justify-content-around">
        <b-button show variant="primary" @click="modalShow = !modalShow">
          <font-awesome-icon icon="plus-circle"/>  Cadastrar pessoa
        </b-button>
      </div>
    </div>
</template>
